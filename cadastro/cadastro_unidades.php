...
if (isset($_GET['sucesso']) && $_GET['sucesso'] === "sucesso") {
    $alert_message = "  Unidade cadastrada.";
    $alert_class = "alert-success ";
} elseif (isset($_GET['error']) && $_GET['error'] === "error") {
    $alert_message = "Essa Unidade já está cadastrada.";
            ...
            <div class="formulario">
                <form class="form" action='cadastro_data.php' method='POST'>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="input-container">
                                <input id="tagInput" name="unidade" placeholder="Unidade" type="text" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="botoes" id="botoesUpdate" style="display: none;">
                        <button type="button" name="submitDesativarUnidade" value="submitDesativarUnidade" class="btn btn-danger" onclick="rp_swall(this, 'Enviar', ' Deseja desativar está Unidade?', 'warning', 60000, true)">
                        ...
                        <button type="button" name="submitAtivarUnidade" value="submitAtivarUnidade" class="btn btn-success" onclick="rp_swall(this, 'Enviar', ' Deseja atualizar está Unidade?', 'success', 60000, true)">
