...
<body>
    ...
    <div class="cardCookie" id="cookie-notice">
        ...
        <p class="cookieHeading">Nós usamos cookies.</p>
        <p class="cookieDescription">Nós usamos cookies e outras tecnologias semelhantes para melhorar a sua experiência em nossos serviços, personalizar publicidade e recomendar conteúdo de seu interesse. Ao utilizar nossos serviços, você está ciente dessa funcionalidade. Conheça nosso Portal da Privacidade e consulte nossa Política de Privacidade.</p>
        <div class="buttonContainer">
            <button class="acceptButton" onclick="acceptCookies()">Aceitar</button>
            <button class="declineButton" onclick="rejectCookies()">Recusar</button>
        </div>
    </div>
    <script>
