 ...
 */
	...
	*[dir='rtl'] div.dt-container div.dt-search input {
	...
	#listar-membros tbody tr:nth-child(even) {
		background-color: #fff;
		color: black;
		/* Cor do texto para contrastar */
	}

	#listar-membros tbody tr:nth-child(odd) {
	...
	.linha-azul{
        background-color: #8b8b8b7d !important;
    }
